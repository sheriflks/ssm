...
if(conf('xtra-fitur',2) != 'true') ShennDie(['result' => false,'data' => null,'message' => 'Fitur tidak tersedia.']);
...
if(isset($_POST['key']) && isset($_POST['sign']) && isset($_POST['type'])) {
    ...
    if($type == 'order')    require 'game-feature-order.php';
    if($type == 'status')   require 'game-feature-status.php';
    if($type == 'service')  require 'game-feature-service.php';
} else {
